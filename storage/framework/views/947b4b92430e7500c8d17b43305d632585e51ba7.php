...
<?php $__env->startSection('js'); ?>
    ...
    <?php echo e(Form::open(['url'=>URL::action('Background\FileController@postCreate'),'id'=>'form1'])); ?>
    ...
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="<?php echo e(URL::action('Background\FileController@getList')); ?>"><span>上传配置管理</span></a>
        <i class="arrow"></i>
        <span>添加配置</span>
    </div>
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">添加上传配置</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <?php echo e(Form::select('type',\App\Http\Model\Background\File::type())); ?>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-checkbox">
                    <?php echo e(Form::checkbox('is_enable',true,false)); ?>
