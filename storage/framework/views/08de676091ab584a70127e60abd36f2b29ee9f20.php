...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['url'=>URL::action('Admin\ToolsController@postCreate'),'id'=>'form1'])); ?>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    <?php echo e(Form::select('parent_id',\App\Http\Model\Admin\ToolsList::tree(1),$parent_id)); ?>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-multi-checkbox">
                        <span>
                            <?php echo e(Form::checkbox('is_top',true,null,['id'=>'is_top'])); ?>

                            <?php echo e(Form::label('is_top','置顶')); ?>

                            <?php echo e(Form::checkbox('is_red',true,null,['id'=>'is_red'])); ?>

                            <?php echo e(Form::label('item1','推荐')); ?>

                            <?php echo e(Form::checkbox('is_hot',true,null,['id'=>'is_hot'])); ?>

                            <?php echo e(Form::label('item1','热门')); ?>

                            <?php echo e(Form::checkbox('is_slide',true,null,['id'=>'is_slide'])); ?>
