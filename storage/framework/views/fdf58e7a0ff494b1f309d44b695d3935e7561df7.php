...
<link href="<?php echo e(asset('admin/theme/css/index_style.css')); ?>" rel="stylesheet" type="text/css">
...
<?php $__env->startSection('content'); ?>
    ...
    <audio controls autoplay class="audio">
        <source src="<?php echo e(asset('admin/theme/css/Music.mp3')); ?>" type="audio/mp3">
        <source src="<?php echo e(asset('admin/theme/css/Music.ogg')); ?>" type="audio/ogg">
        <source src="<?php echo e(asset('admin/theme/css/Music.aac')); ?>" type="audio/mp4">
    </audio>
    <!--音乐 背景应用主题 END-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="<?php echo e(url('admin/article/create')); ?>"><i class="fa fa-plus">新增文章</i></a>
                <a href="<?php echo e(url('admin/category/create')); ?>"><i class="fa fa-plus">新增类别</i></a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
