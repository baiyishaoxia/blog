...
<?php $__env->startSection('content'); ?>
    <?php echo e(Form::open(['url'=>URL::action('Admin\ImagesContentController@postCreate'),'id'=>'form1'])); ?>

        <!--导航栏-->
        <div class="location">
            <a href="javascript:history.back(-1);" class="back"><i></i><span>返回上一页</span></a>
            <a href="<?php echo e(URL::action('Admin\IndexController@index')); ?>" class="home"><i></i><span>首页</span></a>
            <i class="arrow"></i>
            <span>图片列表</span>
        </div>
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        <?php echo e(Form::select('ImgClass_Id',\App\Http\Model\Background\ImagesClass::tree(0))); ?>
