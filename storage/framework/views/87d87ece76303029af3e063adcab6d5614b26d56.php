<style type="text/css">
    a { color:#555}
    html { height: 100%; width: 100%; background: url( <?php echo e(asset('home/images/bj.png')); ?> ) repeat; }
...
<div class="cw404">
    <div class="cw404_top">
        <div class="top_left"><img src="<?php echo e(asset('home/images/cw4.png')); ?>"></div>
