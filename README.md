# blog
Laravel框架是一个为Web工匠准备的PHP框架，让你从意大利面条一样杂乱的代码中解放出来，从而快速构建简洁、优雅、功能强大的web应用。

# 安装

1、下载Blog源码  [点击此处下载](https://github.com/baiyishaoxia/blog/archive/master.zip)
...
```apache
  <VirtualHost *:80>
    ...
    DocumentRoot D:/php/blog/public
    <Directory  "D:/php/blog/public">
