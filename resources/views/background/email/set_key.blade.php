...
@endsection
@section('content')
    {{Form::open(['url'=>URL::action('Background\EmailKeyController@postSetKey'),'id'=>'form1'])}}
    ...
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="{{URL::action('Background\AdminController@getList')}}"><span>配置管理</span></a>
        <i class="arrow"></i>
        <span>配置key</span>
    </div>
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">邮件服务商设置Key</a></li>
                </ul>
            </div>
        </div>
    </div>
