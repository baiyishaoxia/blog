    ...
    <div id="floatHead" class="toolbar-wrap">
        <div class="toolbar">
            <div class="box-wrap">
                ...
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="{{URL::action('Background\EmailController@getCreate')}}"><i></i><span>新增</span></a></li>
                        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
                        <li><a href="{{URL::action('Background\EmailController@postDel')}}" class="del btndel" ><i></i><span>删除</span></a></li>
                    </ul>
                </div>
                <div class="r-list">
                    <div class="rule-single-select">
                        {{Form::select('field',['host'=>'SMTP服务器','username'=>'发件人账户'],Request::get('field'))}}
                    </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            ...
            @foreach($data as $key => $val)
                <tr>
                    ...
                    <td><a href="{{URL::action('Background\EmailKeyController@getSetKey',['sms_id'=>$val->id])}}">配置Key</a></td>
                    <td align="center">
                        {{$val->created_at}}
                    </td>
                    <td align="center">
                        <a href="{{URL::action('Background\EmailController@getEdit',['id'=>$val->id])}}">编辑</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
