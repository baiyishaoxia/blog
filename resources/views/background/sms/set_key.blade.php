...
@endsection
@section('content')
    {{Form::open(['url'=>URL::action('Background\SmsKeyController@postSetKey'),'id'=>'form1'])}}
    {{Form::hidden('sms_id',$sms_id)}}
    <!--导航栏-->
    <div class="location">
        <a href="javascript:history.back(-1);" class="back"><i></i><span>返回上一页</span></a>
        <a href="{{URL::action('Admin\IndexController@info')}}" class="home"><i></i><span>首页</span></a>
        <i class="arrow"></i>
        <a href="{{URL::action('Admin\IndexController@index')}}"><span>短信管理</span></a>
        <i class="arrow"></i>
        <span>短信服务商设置Key</span>
    </div>
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">短信服务商设置Key</a></li>
                </ul>
            </div>
        </div>
    </div>
