...
@endsection
@section('content')
    {{Form::open(['url'=>URL::action('Background\AdminController@postCreate'),'id'=>'form1'])}}
        <!--导航栏-->
        <div class="location">
        ...
        <div id="floatHead" class="content-tab-wrap">
            <div class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a class="selected" href="javascript:;">管理原信息</a></li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="tab-content">
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-checkbox">
                        {{Form::checkbox('is_lock',true,false)}}
                    </div>
            ...
            <dl>
                <dt>登陆密码</dt>
                <dd>
                    {{Form::password('password',['class'=>'input normal','datatype'=>'*6-20'])}}
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <dl>
                <dt>确认密码</dt>
                <dd>
                    {{Form::password('password_confirmation',['class'=>'input normal','datatype'=>'*6-20'])}}
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <dl>
            ...
            <dl>
                <dt>域名</dt>
                <dd>
                    {{Form::text('url',null,['class'=>'input normal','datatype'=>'*'])}}
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <dl>
