...
@section('js')
    ...
    @endsection
    @section('content')
    {{Form::model($data,['url'=>URL::action('Background\IpBlacklistsController@postEdit'),'id'=>'form1'])}}
        {{Form::hidden('id')}}
            <!--导航栏-->
    <div class="location">
        ...
        <i class="arrow"></i>
        <a href="{{URL::action('Background\AdminController@getList')}}"><span>黑名单管理</span></a>
        <i class="arrow"></i>
        <span>修改</span>
    </div>
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">修改黑名单</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    {{Form::select('type',\App\Http\Model\Background\IpBlacklists::typeList())}}
                </div>
                <span class="Validform_checktip">*</span>
            </dd>
        </dl>
