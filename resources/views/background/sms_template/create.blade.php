...
@endsection
@section('content')
    {{Form::open(['url'=>URL::action('Background\SmsTemplateController@postCreate'),'id'=>'form1'])}}
    <!--导航栏-->
    <div class="location">
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">添加短信模板</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-checkbox">
                        {{Form::checkbox('is_sys',true,true)}}
                    </div>
