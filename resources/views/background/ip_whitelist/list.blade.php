    ...
    <div id="floatHead" class="toolbar-wrap">
        <div class="toolbar">
            <div class="box-wrap">
                ...
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="{{URL::action('Background\IpWhitelistsController@getCreate')}}"><i></i><span>新增</span></a></li>
                        <li><a class="all" href="javascript:;" onclick="checkAll(this);"><i></i><span>全选</span></a></li>
                        <li><a href="{{URL::action('Background\IpWhitelistsController@postDel')}}" class="del btndel" ><i></i><span>删除</span></a></li>
                    </ul>
                </div>
                <div class="r-list">
                    <div class="rule-single-select">
                        {{Form::select('type',array_merge([''=>'所有应用'],\App\Http\Model\Background\IpWhitelists::typeList()),Request::get('type'))}}
                    </div>
                    <div class="rule-single-select">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
            ...
            @foreach($data as $key => $val)
                <tr>
                    ...
                    <td align="center">
                        <a href="{{URL::action('Background\IpWhitelistsController@getEdit',['id'=>$val->id])}}">编辑</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
