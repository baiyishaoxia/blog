...
@endsection
@section('content')
    {{Form::open(['url'=>URL::action('Background\AdminRoleController@postCreate'),'id'=>'form1'])}}
    <!--导航栏-->
    <div class="location">
    ...
    <div id="floatHead" class="content-tab-wrap">
        <div class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    <li><a class="selected" href="javascript:;">添加角色信息</a></li>
                </ul>
            </div>
        </div>
    </div>
        ...
        <dl>
            ...
            <dd>
                <div class="rule-single-select">
                    {{Form::select('role_type',['1'=>'系统管理员','0'=>'超级管理员'])}}
                </div>
            </dd>
        </dl>
                            ...
                            <td>
                                <span class="cbllist">
                                    @foreach($val['child'] as $k => $v)
                                        {{Form::checkbox('route[]',$v['id'],$v['title']=='必选节点'?true:false,['id'=>'ck'.$k.$key])}}
