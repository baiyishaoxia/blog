...
@section('content')
    <div class="page bk_content" style="top: 0;">
            ...
            @foreach($cart_items as $cart_item)
                <div class="weui_cell">
                    <div class="weui_cell_hd">
                        <img src="{{Storage::url($cart_item->product->art_thumb)}}" alt="" class="bk_icon">
                    </div>
                    <div class="weui_cell_bd weui_cell_primary">
                        <p class="bk_summary">{{$cart_item->product->art_title}}</p>
                    </div>
                    <div class="weui_cell_ft">
                        <span class="bk_price">{{$cart_item->product->art_order}}</span>
                        <span> x </span>
        ...
        <form action="{{URL::action('Admin\MobileApi\PayController@aliPay')}}" id="alipay" method="post">
            {{ csrf_field() }}
