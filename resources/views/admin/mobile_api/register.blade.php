...
<a href="{{URL::action('Admin\MobileApi\MemberController@login')}}" class="bk_bottom_tips bk_important">已有帐号? 去登录</a>
@endsection
  ...
  function onRegisterClick() {
    $('input:radio[name=register_type]').each(function(index, el) {
      if($(this).attr('checked') == 'checked') {
        ...
        $.ajax({
          type: "POST",
          url: '{{URL::action('Admin\MobileApi\MemberController@postRegister')}}',
          dataType: 'json',
          cache: false,
