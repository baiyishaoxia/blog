...
.new-btn-login{
    ...
    background-image: url("{{base_path()}}.\app\Common\alipay\images\new-btn-fixed.png");
    border: medium none;
}
.new-btn-login{
...
<body text=#000000 bgColor=#ffffff leftMargin=0 topMargin=4>
	<div id="main">
        ...
        <form name=alipayment action={{URL::action('Admin\MobileApi\PayController@aliPay')}} method=post target="_blank">
        ...
        <div id="foot">
			<ul class="foot-ul">
				...
				<li>
					支付宝版权所有 2011-{{date('Y',time())}} ALIPAY.COM
				</li>
			</ul>
		</div>
	</div>
