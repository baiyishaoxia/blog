...
@endsection
@section('content')
    {{Form::model(\App\Http\Model\Background\ImagesClass::find($id),['url'=>URL::action('Admin\ImagesListController@postEdit'),'id'=>'form1'])}}
        <!--导航栏-->
        {{Form::hidden('Id')}}
        <div class="location">
            ...
            <i class="arrow"></i>
            <a href="{{URL::action('Admin\ImagesListController@index')}}"><span>所有照片</span></a>
            ...
            <dl>
                ...
                <dd>
                    <div class="rule-single-select">
                        {{Form::select('Pid',\App\Http\Model\Background\ImagesClass::tree(1))}}
                    </div>
                </dd>
            </dl>
            <dl>
